...
class NivelTres(Nivel):
    def __init__(self, pantalla):
        ...
        [2,0,0,0,0,7,9,0,0,0,0,0,0,6,0,0,7,0,0,2],
        [2,10,0,6,0,0,0,0,13,0,12,0,0,0,0,9,0,6,10,2],
        [2,4,5,0,0,0,0,0,11,0,6,14,9,0,0,0,0,5,4,2],
        [2,11,7,9,0,0,5,4,4,4,4,4,4,5,0,0,12,0,11,2],
        [2,4,4,5,0,0,6,0,0,0,9,0,0,0,0,0,5,4,4,2],
        [2,0,0,0,0,0,0,14,0,0,0,0,11,0,0,9,0,0,0,2],
        [2,0,0,9,12,5,4,4,5,0,0,5,4,4,5,0,0,0,0,2],
        [2,14,11,0,6,0,9,0,11,0,14,0,0,0,0,0,0,11,0,2],
        [2,4,4,4,5,9,0,7,5,4,4,4,5,0,0,5,4,4,4,2],
        [8,0,0,9,0,0,6,0,14,0,11,0,0,11,0,0,6,0,0,8],
        ...
        FPS = 30
        FONDO = pygame.image.load(r"src\Assets\images\background\castillo_2.jpg")
        ...
        diccionario_items_juego["sierras_item"] = sierras
        diccionario_items_juego["pinchos_item"] = pinchos
        
        diccionario_enemigo_esqueleto = {}
        diccionario_enemigo_esqueleto["correr_derecha"] = esqueleto_corriendo_derecha
        diccionario_enemigo_esqueleto["correr_izquierda"] = esqueleto_corriendo_izquierda
        diccionario_enemigo_esqueleto["caer_derecha"] = esqueleto_cayendo_derecha
        diccionario_enemigo_esqueleto["caer_izquierda"] = esqueleto_cayendo_izquierda
        diccionario_enemigo_esqueleto["recibir_daño_derecha"] = esqueleto_recibiendo_daño_derecha
        diccionario_enemigo_esqueleto["recibir_daño_izquierda"] = esqueleto_recibiendo_daño_izquierda
        
        diccionario_enemigo_duende = {}
        diccionario_enemigo_duende["correr_derecha"] = duende_corriendo_derecha
        diccionario_enemigo_duende["correr_izquierda"] = duende_corriendo_izquierda
        diccionario_enemigo_duende["caer_derecha"] = duende_cayendo_derecha
        diccionario_enemigo_duende["caer_izquierda"] = duende_cayendo_izquierda
        diccionario_enemigo_duende["recibir_daño_derecha"] = duende_recibiendo_daño_derecha
        diccionario_enemigo_duende["recibir_daño_izquierda"] = duende_recibiendo_daño_izquierda

        diccionario_enemigo_caballero_malvado = {}
        diccionario_enemigo_caballero_malvado["correr_derecha"] = caballero_malvado_corriendo_derecha
        diccionario_enemigo_caballero_malvado["correr_izquierda"] = caballero_malvado_corriendo_izquierda
        diccionario_enemigo_caballero_malvado["caer_derecha"] = caballero_malvado_cayendo_derecha
        diccionario_enemigo_caballero_malvado["caer_izquierda"] = caballero_malvado_cayendo_izquierda
        diccionario_enemigo_caballero_malvado["recibir_daño_derecha"] = caballero_malvado_recibiendo_daño_derecha
        diccionario_enemigo_caballero_malvado["recibir_daño_izquierda"] = caballero_malvado_recibiendo_daño_izquierda
        ...
        lista_plataformas = []
        lista_items = []
        lista_enemigos = self.generar_enemigo_aleatorio(ANCHO, diccionario_enemigo_esqueleto, 2)
        ...
        for fila in mundo:
            ...
            for baldosa in fila:
                ...
                if baldosa == 7:
                    lista_enemigos.append(Esqueleto((65,60), (contador_columnas * TAMAÑO_BALDOSA_GRUESO, contador_filas * TAMAÑO_BALDOSA_GRUESO), diccionario_enemigo_esqueleto, "correr_derecha"))
                if baldosa == 8:
                    if contador_columnas == 0:
                ...
                if baldosa == 11:
                    lista_items.append(Trampa((TAMAÑO_BALDOSA_DELGADO, TAMAÑO_BALDOSA_DELGADO), (contador_columnas * TAMAÑO_BALDOSA_GRUESO, contador_filas * TAMAÑO_BALDOSA_GRUESO + TAMAÑO_BALDOSA_DELGADO + TAMAÑO_BALDOSA_SUPER_DELGADO), diccionario_items_juego, "sierras_item"))
                if baldosa == 12:
                    lista_enemigos.append(Personaje_enemigo((65,60), (contador_columnas * TAMAÑO_BALDOSA_GRUESO, contador_filas * TAMAÑO_BALDOSA_GRUESO), diccionario_enemigo_duende, "correr_derecha"))
                if baldosa == 13:
                    lista_enemigos.append(Caballero_malvado((75,60), (contador_columnas * TAMAÑO_BALDOSA_GRUESO, contador_filas * TAMAÑO_BALDOSA_GRUESO), diccionario_enemigo_caballero_malvado, "correr_derecha"))
                if baldosa == 14:
    ...
    def generar_enemigo_aleatorio(self, ancho_pantalla, diccionario_enemigos, cantidad_enemigos):
        ...
        for i in range(cantidad_enemigos):
            ...
            nuevo_enemigo = Esqueleto((65,60),(x, y), diccionario_enemigos, "correr_derecha")
